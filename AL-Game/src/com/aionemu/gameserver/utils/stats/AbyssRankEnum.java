...
public enum AbyssRankEnum
{
	 ...
	 * @param quota
	 */
	private AbyssRankEnum(int id, int pointsGained, int pointsLost, int apRequired, int gpRequired, int quota, int dailyReduceGp, int weeklyReduceGp, int descriptionId) {
		this.id = id;

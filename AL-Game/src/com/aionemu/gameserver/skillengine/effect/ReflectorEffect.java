...
public class ReflectorEffect extends ShieldEffect {
	...
	public void startEffect(final Effect effect) {
		...
		AttackShieldObserver asObserver = new AttackShieldObserver(hit, this.value, this._percent, false, effect, this.hitType, getType(), this.hitTypeProb, this.minRadius, this._radius, null, 0, 0);

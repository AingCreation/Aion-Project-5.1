...
public class PolishChargeCondition extends ChargeCondition {
	...
	public boolean validate(Skill env) {
		if (env.getEffector() instanceof Player) {
			...
			Item mainHandWeapon = effector.getEquipment().getMainHandWeapon();
			if (mainHandWeapon != null) {
				if (mainHandWeapon.getIdianStone() != null) {
					mainHandWeapon.getIdianStone().decreasePolishCharge(effector, this.value);
				}
			}
		}
		return true;

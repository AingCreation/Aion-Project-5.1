...
public class BrokerService {
	...
	private Item buyPart(Race playerRace, BrokerItem buyingItem, long price, long itemCount) {
		...
		BrokerItem brokerItem = new BrokerItem(newItem, price, buyingItem.getSeller(), buyingItem.getSellerId(), brokerRace, buyingItem.isSplitSell());
	...
	private static void copyItemInfo(Item oldItem, Item newItem) {
		...
		newItem.setWrappableCount(oldItem.getWrappableCount());
		newItem.setAuthorize(oldItem.getAuthorize());
		newItem.setPacked(oldItem.isPacked());
		newItem.setAmplification(oldItem.isAmplified());

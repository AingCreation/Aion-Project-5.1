...
public class EnglishLanguage extends GeneralMuiHandler {
    ...
    private static enum messages {
        ...
        CONVERT_GC_TO_GC_SUCCESS("Exchange Success, Check your Credit on our website http://aion.dreamergames.id"),
        ...
        STR_CANNOT_JOIN_EVENT_COOLDOWN("You need to wait for %s to enter battle again."),
        STR_CANNOT_JOIN_EVENT_ENTRY_LIMIT("Your entry count for this battle has limited."),
        STR_ONLINE_BONUS_GC_ADD("You have received Credit. Check your credit at http://dreamaion.net."),
        /*=======END GAME STRING======================================================*/
